...
function processExcelData(data) {
    ...
    if (quizData.length > 0) {
        ...
        // Extract available years and subjects
...
function processJsonData(data) {
    ...
    // Process JSON data to ensure it has year and subject fields with default values
...
// Extract available years and subjects from questions
...
function applyFilters() {
    ...
    saveFilters(selectedYears, selectedSubjects, randomize);
...
// Save filters to localStorage
function saveFilters(years, subjects, randomize) {
